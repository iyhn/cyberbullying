...
print("Naive Bayes")
CrossValNaive = cross_val_score(Naive, X, y, cv=5, scoring=scoring)
...
CrossValNaiveTFIDF = cross_val_score(Naive_tfidf, X_tfidf, y_tfidf, cv=5, scoring=scoring)
...
CrossValSVM = cross_val_score(SVM, X, y, cv=5, scoring=scoring)
...
CrossValSVMTFIDF = cross_val_score(SVM_tfidf, X_tfidf, y_tfidf, cv=5, scoring=scoring)
...
print("Random forest")
CrossValRandom = cross_val_score(rm, X, y, cv=5, scoring=scoring)
...
CrossValRandomTFIDF = cross_val_score(rm_tfidf, X_tfidf, y_tfidf, cv=5, scoring=scoring)
...
print("Logistic")
CrossValLogistic = cross_val_score(logistic, X, y, cv=5, scoring=scoring)
...
CrossValLogisticTFIDF = cross_val_score(logistic_tfidf, X_tfidf, y_tfidf, cv=5, scoring=scoring)
