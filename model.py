...
vectorizer = CountVectorizer(ngram_range=(2,2),tokenizer=tokenizer_thai)
tfidf_vect = TfidfVectorizer(ngram_range=(2,2),tokenizer=tokenizer_thai)
...
print(sum(CrossValNaive['test_accuracy'])/5)
print(sum(CrossValNaive['test_precision_macro'])/5)
print(sum(CrossValNaive['test_recall_macro'])/5)
print(sum(CrossValNaive['test_f1_macro'])/5)
...
print(sum(CrossValNaiveTFIDF['test_accuracy'])/5)
print(sum(CrossValNaiveTFIDF['test_precision_macro'])/5)
print(sum(CrossValNaiveTFIDF['test_recall_macro'])/5)
print(sum(CrossValNaiveTFIDF['test_f1_macro'])/5)
...
print(sum(CrossValSVM['test_accuracy'])/5)
print(sum(CrossValSVM['test_precision_macro'])/5)
print(sum(CrossValSVM['test_recall_macro'])/5)
print(sum(CrossValSVM['test_f1_macro'])/5)
...
print(sum(CrossValSVMTFIDF['test_accuracy'])/5)
print(sum(CrossValSVMTFIDF['test_precision_macro'])/5)
print(sum(CrossValSVMTFIDF['test_recall_macro'])/5)
print(sum(CrossValSVMTFIDF['test_f1_macro'])/5)
SVM.fit(X,y)
...
print(sum(CrossValRandom['test_accuracy'])/5)
print(sum(CrossValRandom['test_precision_macro'])/5)
print(sum(CrossValRandom['test_recall_macro'])/5)
print(sum(CrossValRandom['test_f1_macro'])/5)
...
print(sum(CrossValRandomTFIDF['test_accuracy'])/5)
print(sum(CrossValRandomTFIDF['test_precision_macro'])/5)
print(sum(CrossValRandomTFIDF['test_recall_macro'])/5)
print(sum(CrossValRandomTFIDF['test_f1_macro'])/5)
rm.fit(X,y)
...
print(sum(CrossValLogistic['test_accuracy'])/5)
print(sum(CrossValLogistic['test_precision_macro'])/5)
print(sum(CrossValLogistic['test_recall_macro'])/5)
print(sum(CrossValLogistic['test_f1_macro'])/5)
...
print(sum(CrossValLogisticTFIDF['test_accuracy'])/5)
print(sum(CrossValLogisticTFIDF['test_precision_macro'])/5)
print(sum(CrossValLogisticTFIDF['test_recall_macro'])/5)
print(sum(CrossValLogisticTFIDF['test_f1_macro'])/5)
logistic.fit(X,y)
