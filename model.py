...
print(sum(CrossValNaive['recall'])/5)
print(sum(CrossValNaive['f1_macro'])/5)
print(sum(CrossValNaive['precision'])/5)
...
print(sum(CrossValNaiveTFIDF['recall'])/5)
print(sum(CrossValNaiveTFIDF['f1_macro'])/5)
print(sum(CrossValNaiveTFIDF['precision'])/5)
# Naive.fit(X,y)
...
print(sum(CrossValSVM['recall'])/5)
print(sum(CrossValSVM['f1_macro'])/5)
print(sum(CrossValSVM['precision'])/5)
...
print(sum(CrossValSVMTFIDF['recall'])/5)
print(sum(CrossValSVMTFIDF['f1_macro'])/5)
print(sum(CrossValSVMTFIDF['precision'])/5)
SVM.fit(X,y)
...
print(sum(CrossValRandom['recall'])/5)
print(sum(CrossValRandom['f1_macro'])/5)
print(sum(CrossValRandom['precision'])/5)
...
print(sum(CrossValRandomTFIDF['recall'])/5)
print(sum(CrossValRandomTFIDF['f1_macro'])/5)
print(sum(CrossValRandomTFIDF['precision'])/5)
rm.fit(X,y)
...
print(sum(CrossValLogistic['recall'])/5)
print(sum(CrossValLogistic['f1_macro'])/5)
print(sum(CrossValLogistic['precision'])/5)
...
print(sum(CrossValLogisticTFIDF['recall'])/5)
print(sum(CrossValLogisticTFIDF['f1_macro'])/5)
print(sum(CrossValLogisticTFIDF['precision'])/5)
logistic.fit(X,y)
